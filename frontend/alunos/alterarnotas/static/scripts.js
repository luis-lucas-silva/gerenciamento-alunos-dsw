...
function listarAlunos(idDisciplina = 0) {
    var url = 'http://localhost/atividadefinal2/backend/alunos/relalterarnota.php?type=alunos&idDisciplina=' + idDisciplina;
...
function listarDisciplinas() {
    var url = "http://localhost/atividadefinal2/backend/alunos/relalterarnota.php?type=disciplinas&idDisciplina=0";
    const options = {
        method: "GET",
        headers: {
            "Content-Type": "application/json"
